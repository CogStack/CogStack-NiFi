...
openssl req -new -key "$1.key" -out "$1.csr" -subj $SUBJ_LINE
...
openssl x509 -req -days $CERTIFICATE_TIME_VAILIDITY_IN_DAYS -in "$1.csr" -CA $CA_ROOT_CERT -CAkey $CA_ROOT_KEY -CAcreateserial -out "$1.pem"
