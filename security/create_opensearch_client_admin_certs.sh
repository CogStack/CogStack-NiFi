...
#     - ROOT_CERTIFICATE_KEYSTORE_PASSWORD
#     - ES_CERTIFICATE_TIME_VALIDITY_IN_DAYS
#     - ES_KEY_SIZE
#     - ES_CLIENT_SUBJ_LINE, ES_CLIENT_SUBJ_ALT_NAMES
#     - ES_CLIENT_CERT_NAME
#     - ES_ADMIN_SUBJ_LINE
#
# Produces:
#     - ./es_certificates/opensearch/${ES_CLIENT_CERT_NAME}.{key,pem,csr,p12}
#     - ./es_certificates/opensearch/admin.{key.pem,crt,csr}
# ==============================================================================
